...
export default function PricingPage() {
  ...
  const bannerText = "This is a demo project, and while we aim to provide a wide range of features, functionality may vary and not all listed features are guaranteed.";
